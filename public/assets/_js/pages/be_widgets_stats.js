...
class pageWidgetsStats {
  ...
  static initWidgetsChartJS() {
    ...
    // Chart Containers
    let chartWidgetLinesCon = document.getElementById(
      "js-chartjs-widget-lines"
    );
    let chartWidgetLinesCon2 = document.getElementById(
      "js-chartjs-widget-lines2"
    );
    let chartWidgetLinesCon3 = document.getElementById(
      "js-chartjs-widget-lines3"
    );
    let chartWidgetLinesCon4 = document.getElementById(
      "js-chartjs-widget-lines4"
    );

    // Charts letiables
    let chartWidgetLines,
      chartWidgetLines2,
      chartWidgetLines3,
      chartWidgetLines4;
