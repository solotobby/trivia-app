...
class pageDashboard {
  ...
  static initDashboardChartJS() {
    ...
    // Chart Containers
    let chartDashboardLinesCon = document.getElementById(
      "js-chartjs-dashboard-lines"
    );
    let chartDashboardLinesCon2 = document.getElementById(
      "js-chartjs-dashboard-lines2"
    );
