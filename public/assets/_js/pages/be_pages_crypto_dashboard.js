...
class pageDashboardCrypto {
  ...
  static initChartsCrypto() {
    ...
    let chartEthereumData = [
      500, 525, 584, 485, 470, 320, 380, 580, 620, 785, 795, 801, 799, 750, 900,
      920, 930, 1300, 1250, 1150, 1365, 1258, 980, 870, 860, 925, 999, 1050,
      1090, 1100,
    ];
    let chartLitecoinData = [
      300, 320, 330, 331, 335, 340, 358, 310, 220, 180, 190, 195, 203, 187, 198,
      258, 270, 340, 356, 309, 218, 230, 242, 243, 250, 210, 205, 226, 214, 250,
    ];

    // Init Bitcoin Chart on Tab Shown
    document
      .getElementById("crypto-coins-btc-tab")
    ...
    document
      .getElementById("crypto-coins-eth-tab")
      .addEventListener("shown.bs.tab", (e) => {
    ...
    document
      .getElementById("crypto-coins-ltc-tab")
      .addEventListener("shown.bs.tab", (e) => {
