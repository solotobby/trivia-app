...
class pageDashboardEcom {
  ...
  static initEcomChartJS() {
    ...
    // Chart Containers
    let chartEcomEarningsCon = document.getElementById(
      "js-chartjs-ecom-dashboard-earnings"
    );
    let chartEcomOrdersCon = document.getElementById(
      "js-chartjs-ecom-dashboard-orders"
    );
