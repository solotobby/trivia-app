...
class pageDashboardCorporate {
  ...
  static initCorporateChartJS() {
    ...
    // Chart Containers
    let chartCorporateLinesCon = document.getElementById(
      "js-chartjs-corporate-lines"
    );
    let chartCorporateLinesCon2 = document.getElementById(
      "js-chartjs-corporate-lines2"
    );
